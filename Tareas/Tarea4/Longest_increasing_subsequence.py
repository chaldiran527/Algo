def funcion_lis(arr):
    ...
    for i in range(1, n):  # itera sobre todos los elementos del arreglo
        ...
        for j in range(i):  # itera hasta la posicion actual que se esta iterando sobre el arreglo de tamanio n
            """
    ...
    while (pos != -1): # ciclo while mientras el valor de la posicion en la tabla es diferente a -1
